...
brew install -q elixir elixir-ls ruff
brew install -q katago

brew install --cask -q 1password raycast google-chrome linearmouse shottr spotify
...
brew install --cask -q raspberry-pi-imager inkscape gimp figma
